...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_eus to login script."
...
# the current dir:
if   test x${GTLANG_eus} = x ; then
	echo "WARNING: The variable \${GTLANG_eus} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_eus} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_eus} has the value:"
	echo "  ${GTLANG_eus}"
