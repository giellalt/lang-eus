...
This directory contains source files for the Basque language morphology
...
-   <https://giellalt.uit.no/lang/eus/index.html> (analyser)
-   <https://giellalt.uit.no/index.html> (infrastructure)

Requirements
------------

In order to compile and use Basque language morphology and dictionaries,
you need:
...
The Basque language sources can be acquired using [giella SVN
